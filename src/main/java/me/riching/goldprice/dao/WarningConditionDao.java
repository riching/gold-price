...
public class WarningConditionDao extends NamedParameterJdbcDaoSupport {
	...
	private static final String INSERT = "insert into warning_condition(start_hour, end_hour) values(?, ?)";
	...
	private static final String GET = "select id, start_hour, end_hour, status, update_time from warning_condition where status=0";
